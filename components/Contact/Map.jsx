...
const Map = () => {
  return (
    <div classNames="w-screen h-[30rem] bg-bgColor">
      <section className="w-full text-txtColor body-font relative">
        <div className="absolute w-full inset-0 bg-txtColor/5">
          <iframe
            width="100%"
            height="100%"
            frameborder="0"
